...
try:
    ...
    #   myrobot.set_modality("motor", list(random.choice(utils.list_of_motions).values()))  
    #   myrobot.set_modality("motor", list(list_of_motions[1].values()))  
    #   counter=0
    #   motion_counter=0
    #   counter += 1
    #   if counter > 50:
    ...
    #         if motion_counter >= len(list_of_motions):
    #             motion_counter = 0
    #         myrobot.set_modality("motor", list(list_of_motions[motion_counter].values()))
    #         motion_counter += 1
      y = input("enter something")    
      myrobot.set_modality("emotion","angry" )  
      myrobot.set_modality("speech", "Hi")
        # msg = input("Robot say: ")
        # myrobot.set_modality("speech", "Hello World")
        # random.choice(utils.emotions_list)
    #   myrobot.set_modality("emotion",random.choice(utils.emotions_list) )
    #   myrobot.set_modality("motor", list(list_of_motions[2].values()))  
    #   time.sleep(10)
      log.info("hello")
except KeyboardInterrupt:
    log.info("Closing down")
